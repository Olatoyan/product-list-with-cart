...
function ConfirmationModal() {
  ...
  return (
    <div
      className={`fixed inset-0 z-30 flex h-full w-full items-center justify-center transition-all duration-300 mobile:items-end ${isOrderConfirmed ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"}`}
    >
